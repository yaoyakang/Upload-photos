    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function finishMobileDate(e) {
                ...
                document.getElementById("start_date").innerText=(date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd;
                document.getElementById("time").value=(date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd;
